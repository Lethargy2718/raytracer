...
void default_scene() {
    ...
    auto earth_texture = make_shared<image_texture>(earthmap);
...
void book2_final_scene(int image_width, int samples_per_pixel, int max_depth) {
    ...
    // Earth
    auto emat = make_shared<lambertian>(make_shared<image_texture>(earthmap));
    world.add(make_shared<sphere>(point3(400,200,400), 100, emat));

    // Marble
    auto marble = make_shared<marble_texture>(0.2);
    world.add(make_shared<sphere>(point3(220,280,300), 80, make_shared<lambertian>(marble)));
...
int main() {
    switch (1) {
        ...
        case 10:
            ...
            break;
        case 11:
            book2_final_scene(1500, 1000, 50);
        default:
            break;
    }
}